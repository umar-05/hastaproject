<section 
    ...
    class="bg-white p-8 rounded-2xl shadow-xl border border-gray-100 max-w-5xl mx-auto mt-8"
>
    ...
    <form method="post" action="{{ route('password.update') }}" class="mt-6 space-y-6 max-w-2xl">
        ...
        <div>
            <label for="current_password" class="block text-xs font-semibold text-gray-500 uppercase tracking-wide mb-2">
                {{ __('Current Password') }}
            </label>
