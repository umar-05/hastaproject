...
>
    ...
    <form method="post" action="{{ route('profile.update') }}">
        ...
        <div class="mb-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                <div>
                    <label for="matricNum" class="block text-xs font-bold text-gray-500 uppercase tracking-wide mb-2">Matric Number</label>
                    <input id="matricNum" name="matricNum" type="text" 
                        class="block w-full bg-gray-50 border border-gray-200 text-gray-500 font-mono text-base rounded-lg py-3 px-4 focus:outline-none cursor-not-allowed" 
                ...
                <div>
                    <label for="phoneNum" class="block text-xs font-bold text-gray-500 uppercase tracking-wide mb-2">Phone Number</label>
                ...
                <div>
                    <label for="faculty" class="block text-xs font-bold text-gray-500 uppercase tracking-wide mb-2">Faculty</label>
                ...
                <div>
                    <label for="icNum_passport" class="block text-xs font-bold text-gray-500 uppercase tracking-wide mb-2">IC / Passport</label>
        ...
        <div class="mb-8">
            ...
            <div class="space-y-6">
                <div class="w-full">
                    <label for="address" class="block text-xs font-bold text-gray-500 uppercase tracking-wide mb-2">Permanent Address</label>
                    <textarea id="address" name="address" rows="3"
                        class="block w-full bg-white border border-gray-300 rounded-lg py-3 px-4 text-gray-700 text-base focus:border-[#bb1419] focus:ring-2 focus:ring-[#bb1419]/20 resize-none" 
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                    <div>
                        <label for="state" class="block text-xs font-bold text-gray-500 uppercase tracking-wide mb-2">State</label>
                        <div class="relative">
                    ...
                    <div>
                        <label for="city" class="block text-xs font-bold text-gray-500 uppercase tracking-wide mb-2">City</label>
                        <div class="relative">
                    ...
                    <div>
                        <label for="postcode" class="block text-xs font-bold text-gray-500 uppercase tracking-wide mb-2">Postcode</label>
                        <x-text-input id="postcode" name="postcode" type="text" class="block w-full bg-white border border-gray-300 rounded-lg py-3 px-4 text-gray-700 text-base focus:border-[#bb1419] focus:ring-2 focus:ring-[#bb1419]/20" :value="old('postcode', $user->postcode)" placeholder="e.g. 81310" />
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div>
                ...
                <div class="space-y-6">
                      <div>
                        ...
                        <x-text-input id="eme_name" name="eme_name" type="text" class="block w-full bg-white border border-gray-300 rounded-lg py-3 px-4 text-gray-700 text-base focus:border-[#bb1419] focus:ring-2 focus:ring-[#bb1419]/20" :value="old('eme_name', $user->eme_name)" />
                      </div>
                      <div class="grid grid-cols-2 gap-6">
                          <div>
                            <label class="block text-xs font-bold text-gray-500 uppercase tracking-wide mb-2">Phone</label>
                            <x-text-input id="emephoneNum" name="emephoneNum" type="text" class="block w-full bg-white border border-gray-300 rounded-lg py-3 px-4 text-gray-700 text-base focus:border-[#bb1419] focus:ring-2 focus:ring-[#bb1419]/20" :value="old('emephoneNum', $user->emephoneNum)" />
                          </div>
                          <div>
                            <label class="block text-xs font-bold text-gray-500 uppercase tracking-wide mb-2">Relationship</label>
                            <input list="relationships" id="emerelation" name="emerelation" class="block w-full bg-white border border-gray-300 rounded-lg py-3 px-4 text-gray-700 text-base focus:border-[#bb1419] focus:ring-2 focus:ring-[#bb1419]/20" value="{{ old('emerelation', $user->emerelation) }}">
            ...
            <div>
                ...
                <div class="space-y-6">
                      <div>
                        <label class="block text-xs font-bold text-gray-500 uppercase tracking-wide mb-2">Bank Name</label>
                        <div class="relative">
                            <select id="bankName" name="bankName" class="block w-full bg-white border border-gray-300 rounded-lg py-3 px-4 text-gray-700 text-base focus:border-[#bb1419] focus:ring-2 focus:ring-[#bb1419]/20 appearance-none cursor-pointer pr-10">
                      ...
                      <div>
                        <label class="block text-xs font-bold text-gray-500 uppercase tracking-wide mb-2">Account Number</label>
                        <x-text-input id="accountNum" name="accountNum" type="text" class="block w-full bg-white border border-gray-300 rounded-lg py-3 px-4 text-gray-700 text-base focus:border-[#bb1419] focus:ring-2 focus:ring-[#bb1419]/20" :value="old('accountNum', $user->accountNum)" />
                      </div>
                </div>
            </div>
        </div>

        <div class="flex items-center justify-end gap-6 pt-8 mt-6 border-t border-gray-100">
    ...
    <script>
        // Existing JS for city/state logic...
        const stateData = {
