...
<div class="container mx-auto px-4 py-8">
    ...
    <div class="mb-8 flex justify-between items-end">
        <div>
            ...
            <p class="text-gray-500 mt-1">Manage pending vehicle movements for today and overdue bookings.</p>
        </div>
        ...
        <div class="bg-white rounded-xl shadow-sm border-l-4 border-green-500 p-6">
            <div class="flex justify-between items-center">
                <div>
                    ...
                    <p class="text-xs text-gray-400 mt-1">Confirmed bookings awaiting collection</p>
                </div>
        ...
        <div class="bg-white rounded-xl shadow-sm border-l-4 border-blue-500 p-6">
            <div class="flex justify-between items-center">
                <div>
                    ...
                    <p class="text-xs text-gray-400 mt-1">Active vehicles due for return</p>
                </div>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
        ...
        <div class="bg-white rounded-xl shadow-lg border border-gray-100 overflow-hidden">
            ...
            <div class="divide-y divide-gray-100">
                ...
                <div class="p-6 hover:bg-gray-50 transition relative">
                    <div class="flex justify-between items-start mb-2">
                        ...
                        {{-- Overdue Badge Logic --}}
                        @if(\Carbon\Carbon::parse($booking->pickupDate)->isPast())
                            <span class="px-2 py-1 bg-red-100 text-red-800 text-xs font-bold rounded uppercase">Overdue</span>
                        @else
                            <span class="px-2 py-1 bg-green-100 text-green-800 text-xs font-bold rounded uppercase">Upcoming</span>
                        @endif
                    </div>
                    ...
                    <div class="flex items-center gap-4 text-sm text-gray-600 mb-4">
                        <div class="flex items-center gap-1">
                            ...
                            {{ \Carbon\Carbon::parse($booking->pickupDate)->format('d M, h:i A') }}
                        </div>
                        <div class="flex items-center gap-1">
            ...
            <div class="divide-y divide-gray-100">
                ...
                <div class="p-6 hover:bg-gray-50 transition">
                    <div class="flex justify-between items-start mb-2">
                        ...
                        @if(\Carbon\Carbon::parse($booking->returnDate)->isPast())
                            <span class="px-2 py-1 bg-red-100 text-red-800 text-xs font-bold rounded uppercase">Overdue</span>
                        @else
                            <span class="px-2 py-1 bg-blue-100 text-blue-800 text-xs font-bold rounded uppercase">Upcoming</span>
                        @endif
                    </div>
                    ...
                    <div class="flex items-center gap-4 text-sm text-gray-600 mb-4">
                        <div class="flex items-center gap-1">
                            <svg class="w-4 h-4 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z"></path></svg>
                            {{ \Carbon\Carbon::parse($booking->returnDate)->format('d M, h:i A') }}
                        </div>
                        <div class="flex items-center gap-1">
                            <svg class="w-4 h-4 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z"></path><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 11a3 3 0 11-6 0 3 3 0 016 0z"></path></svg>
                            {{ $booking->returnLoc }}
                ...
                <div class="p-8 text-center text-gray-500">
                    <div class="inline-flex items-center justify-center w-12 h-12 rounded-full bg-blue-100 mb-3">
                        <svg class="w-6 h-6 text-blue-500" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"/></svg>
                    </div>
                    <p>No returns waiting.</p>
                </div>
                @endforelse
            </div>
        </div>
