...
<div class="grid grid-cols-1 xl:grid-cols-3 gap-8 items-start">
        ...
        <div class="bg-white rounded-3xl shadow-sm border border-gray-100 p-8">
            ...
            <div class="grid grid-cols-7 gap-3 text-center">
                ...
                @for($day = 1; $day <= $daysInMonth; $day++)
                    ...
                    @endphp
                    <div class="aspect-square flex items-center justify-center rounded-xl border {{ $styles }} text-sm font-bold transition-all cursor-default hover:scale-105">
                        {{ $day }}
                    </div>
                @endfor
            </div>
    ...
    <div class="xl:col-span-1 space-y-6">
        <div class="bg-white rounded-3xl shadow-sm border border-gray-100 p-6">
            ...
            <div class="mb-6">
                ...
                <div class="flex justify-between text-[11px] text-gray-400">
                    ...
                    <span class="font-bold text-gray-600">{{ $fleet->taxExpirydate ? $fleet->taxExpirydate->format('d M Y') : '14 Jan 2025' }}</span>
                </div>
            </div>
            ...
            <div>
                ...
                <div class="flex justify-between text-[11px] text-gray-400">
                    <span>Expiry Date:</span>
                    <span class="font-bold text-gray-600">{{ $fleet->insuranceExpirydate ? $fleet->insuranceExpirydate->format('d M Y') : '31 Jan 2025' }}</span>
                </div>
            </div>
        </div>
        ...
        <div class="bg-white rounded-3xl shadow-sm border border-gray-100 p-6">
            ...
            <p class="text-xs text-gray-500 leading-relaxed">{{ $fleet->note ?? 'Vehicle in excellent condition. Last detailed on December 2023.' }}</p>
        </div>
    </div>
</div>
@endsection